<?php
	...
	$response=array();
	$login=mysqli_query($con, "select * from stud_master where sm_cnct='".$user."' or sm_mail='".$user."'");
	if(mysqli_num_rows($login)!=0)
	{
		...
		<head>
			...
			<title>Email System By Hostel Guard</title>
			<style type='text/css'>
																...
																<table border='0' cellpadding='30' cellspacing='0' width='100%'>
																	<tr>
																		<td align='center' valign='top' class='textContent'>
																			<h1 style='color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;'>Reset Your Account Password</h1>
																			...
																			<table border='0' cellpadding='0' cellspacing='0' width='100%'>
																				<tr>
																					<td valign='top' class='textContent'>
																						<table width='100%'>
																							<tr>
																							<form action='http://192.168.43.13/hostel/resetpassword.php' method='post'>
																								<td><input type='hidden' name='mail' value='$mail'><input type='hidden' name='status' value='$status'><input type='submit' name='reset' value='Click Here To Reset Password'></td>
																							</form>
																							</tr>
																						</table>
																					</td>
																...
																<table border='0' cellpadding='30' cellspacing='0' width='100%'>
																	<tr>
																		<td valign='top' bgcolor='#E1E1E1'>
																			...
																			<div style='font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;'>
																				<div>Copyright &#169; 2016 <a href='http://www.Hostel.com target='_blank' style='text-decoration:none;color:#828282;'><span style='color:#828282;'>Hostel Guard</span></a>. All&nbsp;rights&nbsp;reserved.</div>
																			</div>
																		</td>
																	</tr>
																</table>
		...
		$headers .= "From: <prachi4vapi@gmail.com>" . "\r\n";
